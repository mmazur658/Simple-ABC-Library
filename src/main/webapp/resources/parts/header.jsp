...
<script src="<%=request.getContextPath()%>/resources/js/show-alert.js"></script>
...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/extra-style-details.css" />
<!-- ICONS -->
