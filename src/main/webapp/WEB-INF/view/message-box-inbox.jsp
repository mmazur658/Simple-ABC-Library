...
<head>
	...
	<title>Simple ABC Library - Message Box - Inbox</title>
</head>
<body>
	...
	<div class="wrapper">
		<div class="container">
			...
			<div>
				<br><br>
				<h2 class="h2-heading">Skrzynka Odbiorcza - Wiadomości ${amountOfResults}</h2>
				...
				<button class="nav-button" onclick="window.location.href='${pageContext.request.contextPath}/message-module/message-box-sent'">Wysłane</button>
				<br><br>
			</div>
	...
	<table>
		<tr>
			...
			<th id="sender-column">Nadawca</th>
		...
		<tr>
			...
			<c:choose>
				<c:when test="${tempMessage.recipientIsRead != 'true'}">
					...
					<td id="sender-column" style="font-weight: bold"><a href="${openMessageLink}">${tempMessage.sender.email}</a></td>
				...
				<c:otherwise>
					...
					<td id="sender-column"><a href="${openMessageLink}">${tempMessage.sender.email}</a></td>
