...
<html>
	...
	<body>
		...
		<div class="wrapper">
			...
			<h2 class="h2-heading">Portal Administratora</h2>
				...
				<button class="big-button" onclick="window.location.href='${pageContext.request.contextPath}/adminstrator/errors-and-problems'"> Błędy i Problemy </button>
				<button class="big-button" onclick="window.location.href='${pageContext.request.contextPath}/adminstrator/configuration'"> Konfiguracja </button>
